...
paste("Appr recombination rate (cM/Mb):", sum(aggregate(maps$genetic_position_male, list(maps$LG), max)$x)/sum(aggregate(maps$length, list(maps$chrom), max)$x)*1000000)
